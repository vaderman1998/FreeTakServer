...
def delete_mission_contents(mission_id: str):
    ...
    try:
        response = HTTPTakApiCommunicationController().make_request("DeleteMissionContents", "mission", {"mission_id": mission_id, "uid": uid, "hash": content_hash, "creatorUid": creator_uid}, None, True)
    ...
    HTTPTakApiCommunicationController().make_request("MissionContentDeletedNotification", "mission", {"change_id": change_id}, None, synchronous=False)
